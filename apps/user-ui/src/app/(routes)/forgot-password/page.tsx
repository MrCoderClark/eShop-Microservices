          ...
          {step === 'email' && (
            <>
              ...
              <form onSubmit={handleSubmit(onSubmitEmail)}>
                ...
                >
                  {requestOtpMutation.isPending ? 'Senidng OTP...' : 'Submit'}
                </button>
          ...
          {step === 'otp' && (
            <>
              ...
              <div className="flex justify-center gap-6">
                {otp?.map((digit: string, index: number) => (
                  <input
                    ...
                    maxLength={1}
                    value={digit}
                    className="w-12 h-12 text-center border border-gray-300 outline-none rounded-[5px]"
              ...
              <button
                ...
                className="w-full mt-4 text-lg cursor-pointer bg-blue-500 text-white rounded-lg"
              >
              ...
              {canResend ? (
                <button
                  onClick={() =>
                    requestOtpMutation.mutate({ email: userEmail as string })
                  }
